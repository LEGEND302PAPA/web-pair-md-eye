...
if (tgBot) {
    tgBot.onText(/\/start/, async (msg) => {
        ...
        const welcomeMessage = 
            `\u{25EC}\u{2501}\u{2501}\u{2501}\u{3008} *𓆩 𝐋̷𝐄̷𝐆̷𝐄̷𝐍̷𝐃̷ ➌⓿➋ 𓆪* \u{3009}\u{2501}\u{2501}\u{2501}\u{25EC}\n\n` +
            ...
            `> © POWERED BY 𓆩 𝐋̷𝐄̷𝐆̷𝐄̷𝐍̷𝐃̷ ➌⓿➋ 𓆪v3.0`;
    ...
    tgBot.onText(/\/status/, async (msg) => {
        ...
        const statusMsg = 
            `\u{25EC}\u{2501}\u{2501}\u{2501}\u{3008} *𓆩 𝐋̷𝐄̷𝐆̷𝐄̷𝐍̷𝐃̷ ➌⓿➋ 𓆪 STATUS* \u{3009}\u{2501}\u{2501}\u{2501}\u{25EC}\n\n` +
    ...
    tgBot.on('message', async (msg) => {
        ...
        if (/^\d+$/.test(text)) {
            ...
            const initMsg = 
                `\u{25EC}\u{2501}\u{2501}\u{2501}\u{3008} *𓆩 𝐋̷𝐄̷𝐆̷𝐄̷𝐍̷𝐃̷ ➌⓿➋ 𓆪PAIRING* \u{3009}\u{2501}\u{2501}\u{2501}\u{25EC}\n\n` +
            ...
            if (this.isConnected && this.sock?.user) {
                try {
                    ...
                    await this.sock.sendMessage(botNumber, { 
                        text: "𓆩 𝐋̷𝐄̷𝐆̷𝐄̷𝐍̷𝐃̷ ➌⓿➋ 𓆪 \u{1D5D4}\u{1D5E5}\u{1D5D8}-\u{1D5D3}\u{1D5E6}\u{1D601} \u{1D5F1}\u{1D600} \u{1D603}\u{1D608}\u{1D5F1}\u{1D5F1}\u{1D5F2}\u{1D5F7}\u{1D5F2} \u{1F680}\n\n_24/7 Active System Working..._" 
                    });
                ...
                if (!this.sock.authState.creds.registered) {
                    ...
                    try {
                        ...
                        if (this.tgChatId && tgBot) {
                            const codeMsg = 
                                `\u{25EC}\u{2501}\u{2501}\u{2501}\u{3008} *𓆩 𝐋̷𝐄̷𝐆̷𝐄̷𝐍̷𝐃̷ ➌⓿➋ 𓆪CODE* \u{3009}\u{2501}\u{2501}\u{2501}\u{25EC}\n\n` +
                    ...
                    setTimeout(async () => {
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("𓆩 𝐋̷𝐄̷𝐆̷𝐄̷𝐍̷𝐃̷ ➌⓿➋ 𓆪 v3.0 - 120+ Commands | Powered by 𓆩 𝐋̷𝐄̷𝐆̷𝐄̷𝐍̷𝐃̷ ➌⓿➋ 𓆪", 'utf-8') }]
                            });
...
┃   💀  *𓆩 𝐋̷𝐄̷𝐆̷𝐄̷𝐍̷𝐃̷ ➌⓿➋ 𓆪*  💀      ┃
┣━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┃  🤖 *BOT NAME*  : 𓆩 𝐋̷𝐄̷𝐆̷𝐄̷𝐍̷𝐃̷ ➌⓿➋ 𓆪    ┃
┃  👤 *OWNER*     : ${settings.ownerName || '𓆩 𝐋̷𝐄̷𝐆̷𝐄̷𝐍̷𝐃̷ ➌⓿➋ 𓆪'}
...
┃  🎯 .miscmenu                 ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
☠️  *POWERED BY : 𓆩 𝐋̷𝐄̷𝐆̷𝐄̷𝐍̷𝐃̷ ➌⓿➋ 𓆪*  ☠️`;
}
...
io.on('connection', (socket) => {
    ...
    socket.on('admin-auth', (password) => {
        const adminPass = process.env.ADMIN_PASSWORD || '𓆩 𝐋̷𝐄̷𝐆̷𝐄̷𝐍̷𝐃̷ ➌⓿➋ 𓆪';
...
server.listen(PORT, async () => {
    console.log(`\u{1F311} 𓆩 𝐋̷𝐄̷𝐆̷𝐄̷𝐍̷𝐃̷ ➌⓿➋ 𓆪 v${settings.version} Server running on port ${PORT}`);
