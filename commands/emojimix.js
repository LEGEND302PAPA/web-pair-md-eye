...
async function emojimixCommand(sock, chatId, msg) {
    try {
        ...
        const url = `https://tenor.googleapis.com/v2/featured?key=${process.env.TENOR_API_KEY || ""}&contentfilter=high&media_filter=png_transparent&component=proactive&collection=emoji_kitchen_v5&q=${encodeURIComponent(emoji1)}_${encodeURIComponent(emoji2)}`;
